...
4. The user asks about **installing, invoking, or troubleshooting `bugsee-cli`** — a command, a flag, a minimum CLI version, or an exit code → [`bugsee-cli`](../bugsee-cli/SKILL.md)
...
| Install, invoke, or troubleshoot the Bugsee CLI — commands, flags, version floors, exit codes | [`bugsee-cli`](../bugsee-cli/SKILL.md) | `bugsee-cli/SKILL.md` |
